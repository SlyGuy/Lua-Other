...
function TirionFordring_zzz_Gozzzz(pUnit, Event)
	...
	Lich:SetFaction(22)
	Lich:SpawnCreature(3769511, 468, -2130, 1572, Lich:GetO(), 14, 0)
	Lich:SpawnCreature(3769511, 465, -2140, 1572, Lich:GetO(), 14, 0)
	Lich:SpawnCreature(3769511, 468, -2115, 1572, Lich:GetO(), 14, 0)
	Lich:SpawnCreature(3769511, 465, -2105, 1572, Lich:GetO(), 14, 0)
	Lich:GetCreatureNearestCoords(468, -2130, 1572, 3769511):MoveTo(474, -2130, 1572)
	Lich:GetCreatureNearestCoords(465, -2140, 1572, 3769511):MoveTo(469, -2138, 1572)
	Lich:GetCreatureNearestCoords(468, -2115, 1572, 3769511):MoveTo(474, -2115, 1572)
	Lich:GetCreatureNearestCoords(465, -2105, 1572, 3769511):MoveTo(469, -2105, 1572)
...
function Adds_Spawning_Incoming_Dredge_Ghoulsz(pUnit, Event)
	if(math.random(1,2) == 1) then
		Lich:SpawnCreature(3769511, Lich:GetX()+math.random(1,6), Lich:GetY()+math.random(1,6), Lich:GetZ(), Lich:GetO(), 15, 360000)
	else
		Lich:SpawnCreature(3769511, Lich:GetX()-math.random(1,6), Lich:GetY()-math.random(1,6), Lich:GetZ(), Lich:GetO(), 15, 360000)
	end
end
...
function Adds_Spawning_Incoming_Shambling_Horror(pUnit, Event)
	if(math.random(1,2) == 1) then
		Lich:SpawnCreature(3769811, Lich:GetX()+math.random(1,6), Lich:GetY()+math.random(1,6), Lich:GetZ(), Lich:GetO(), 15, 360000)
	else
		Lich:SpawnCreature(3769811, Lich:GetX()-math.random(1,6), Lich:GetY()-math.random(1,6), Lich:GetZ(), Lich:GetO(), 15, 360000)
	end
end
...
function weaiyhoahg_delay(pUnit, Event)
	Lich:SpawnCreature(3769812, Lich:GetX()+math.random(3,6), Lich:GetY()+math.random(3,6), Lich:GetZ(), Lich:GetZ(), 21, 10000)
...
function RandomRagingSpiritAddsThatAreNotRandom(pUnit, Event)
	if(Lich:GetRandomPlayer(0) ~= nil) then
		Lich:SpawnCreature(3769813, Lich:GetRandomPlayer(0):GetX(), Lich:GetRandomPlayer(0):GetY(), Lich:GetRandomPlayer(0):GetZ(), Lich:GetRandomPlayer(0):GetO() , 21, 360000)
	end
end
...
function DelayForDespawnSinceVisualTakesSomeTimeTehe(pUnit, Event)
	...
	if(Lich:GetGameObjectNearestCoords(pUnit:GetX(),pUnit:GetY(),pUnit:GetZ(), 2957197) ~= nil) then
		Lich:GetGameObjectNearestCoords(pUnit:GetX(),pUnit:GetY(),pUnit:GetZ(), 2957197):Despawn(1, 0)
		Lich:CastSpell(46853)
	end
	Lich:SetCombatCapable(0)
	Lich:Unroot()
...
function Soul_Reaper_On_Main_Tank(pUnit, Event)
	if(Lich:GetMainTank() ~= nil) then
		Lich:FullCastSpellOnTarget(69409, Lich:GetMainTank())
	end
end

function Summon_Valkyr_Shadowguard(pUnit, Event)
	Lich:SpawnCreature(25452151, Lich:GetX()+7, Lich:GetY(), Lich:GetZ(), Lich:GetO(), 22, 0)
...
function Spawning_The_Vile_spirits_NoW(pUnit, Event)
	if(Lich:GetRandomPlayer(0) ~= nil) then
	Lich:SpawnCreature(5078151, Lich:GetRandomPlayer(0):GetX(), Lich:GetRandomPlayer(0):GetY(), Lich:GetRandomPlayer(0):GetZ(), Lich:GetRandomPlayer(0):GetO(), 22, 60000)
	end
end
...
function zzzzDebug_Send_Next_Message_LichKing(pUnit, Event)
	...
	if(Lich:GetRandomPlayer(0) ~= nil) then
		Lich:ChannelSpell(71769, Lich:GetRandomPlayer(0))
...
function lich_channel_players_raise_dead(pUnit, Event)
	for k, v in pairs(Lich:GetInRangePlayers()) do
...
function BrokeFrostmourne(pUnit, Event)
	for k, v in pairs(Lich:GetInRangePlayers()) do
		v:StopChannel()
		Lich:StopChannel()
		Lich:CastSpell(37592)
		Lich:CastSpell(72726)
		Lich:FullCastSpell(72398)
		Lich:EquipWeapons(0,0,0)
		Lich:CastSpell(73017)
...
function epiashgyophopapea_Lich_King_Is_Not_A_Happy_Bunny(pUnit, Event)
	...
	Lich:Emote(473, 120000)
	for a, players in pairs(Terenas:GetInRangePlayers()) do
...
function PlayMovieOnceDeathAnimationHasPlayed(pUnit, Event)
	...
	Players_Wiped = 0
	for a, players in pairs(pUnit:GetInRangePlayers()) do
		LuaPacket:CreatePacket(0x464, 4):WriteULong(16)
		players:SendPacketToPlayer(LuaPacket:CreatePacket(0x464, 4))
	end
	if(pUnit:GetGameObjectNearestCoords(428.758, -2124.4, 1594.69, 2508221) ~= nil) then
		pUnit:GetGameObjectNearestCoords(428.758, -2124.4, 1594.69, 2508221):Despawn(1,0)
		pUnit:SpawnGameObject(2508220, 428.758, -2124.4, 1594.69, 0, 360000)
		pUnit:SpawnGameObject(2508219, 430.103, -2124, 1595.93, 3.3, 360000)
	end
end
...
function rage_rage_rage_rage_Rage_rage_r(pUnit, Event)
	...
	if(pUnit:GetClosestPlayer() ~= nil) then
		pUnit:FullCastSpell(69090)
		if(pUnit:GetDistanceYards(pUnit:GetClosestPlayer()) < 4) then
...
function zhgzFlying_Dude_Find_Player(pUnit, Event)
	if(pUnit:GetClosestPlayer() ~= nil) then
		...
		pUnit:ChannelSpell(55520, pUnit:GetClosestPlayer())
		pUnit:MoveTo(pUnit:GetX(), pUnit:GetY(), pUnit:GetZ()+6, pUnit:GetO(), 12288)
		pUnit:GetClosestPlayer():MovePlayerTo(pUnit:GetClosestPlayer():GetX(), pUnit:GetClosestPlayer():GetY(), pUnit:GetClosestPlayer():GetZ()+6, pUnit:GetClosestPlayer():GetO(), 12288)
...
function now_we_have_loaded_preset_We_can_move_on(pUnit, Event)
	if(pUnit:GetClosestPlayer() ~= nil) then
		pUnit:GetClosestPlayer():CastSpell(52241)
		pUnit:GetClosestPlayer():CastSpell(53658)
		pUnit:ChannelSpell(29172, pUnit:GetClosestPlayer())
...
function now_we_have_loaded_preset_We_can_move_on_two(pUnit, Event)
	if(pUnit:GetClosestPlayer() ~= nil) then
		...
		--pUnit:RemoveFromWorld() -- Causes crash
			...
			pUnit:GetClosestPlayer():MovePlayerTo(pUnit:GetX(), pUnit:GetY(), pUnit:GetZ() ,pUnit:GetO(), 12288)
		end
	else
		pUnit:RemoveEvents()
		pUnit:RemoveFromWorld()
